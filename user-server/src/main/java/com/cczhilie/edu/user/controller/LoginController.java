package com.cczhilie.edu.user.controller;

import com.cczhilie.edu.user.constant.CookieConstant;
import com.cczhilie.edu.user.constant.RedisConstant;
import com.cczhilie.edu.user.dataobject.UserInfo;
import com.cczhilie.edu.user.enums.ResultEnum;
import com.cczhilie.edu.user.enums.RoleEnum;
import com.cczhilie.edu.user.service.UserService;
import com.cczhilie.edu.user.utils.CookieUtil;
import com.cczhilie.edu.user.utils.ResultVOUtil;
...
public class LoginController {
    ...
    public ResultVO buyer(@RequestParam("openid") String openid,
        ...
        stringRedisTemplate.opsForValue()
                .set(String.format(RedisConstant.OPENID_TEMPLATE,openid),openid,CookieConstant.expire,TimeUnit.SECONDS);
